...
-   This can be done in a number of ways:
    ...
    -   In software systems, easiest way is to follow:
        -   KISS principle: 'keep it simple stupid'. Keeping the system simple at design time tends to make it easy for
            actors to use the system and prevent misuse. It also helps in understanding and analyzing the system for
